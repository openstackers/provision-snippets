...
baseurl=http://download.eng.bos.redhat.com/released/RHEL-7/7.1/Server/x86_64/os/
enabled=1
gpgcheck=0
...
baseurl=http://download.lab.bos.redhat.com/rel-eng/repos/rhel-7.1-z/x86_64
enabled=1
gpgcheck=0
gpgkey=file:///etc/pki/rpm-gpg/RPM-GPG-KEY-redhat-release
...
baseurl=http://download.lab.bos.redhat.com/released/RHEL-7/7.1/Server-optional/x86_64/os/
enabled=1
gpgcheck=0
gpgkey=file:///etc/pki/rpm-gpg/RPM-GPG-KEY-redhat-release
